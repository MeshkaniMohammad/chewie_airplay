...
import 'package:videoplay/src/air_play_button.dart';
...
//            ),
  ...
  Widget _buildAirPlay(Color iconColor) {
    return Padding(
        padding: EdgeInsets.only(right: 8.0),
    child: AirPlayButton(size: 18.0, color: iconColor,),);
  }
